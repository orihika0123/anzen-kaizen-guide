<template>
  <div>
    ...
    ></todo-list>
    <todo-empty :visible="!visible"></todo-empty>
    <div>
      <next-todo :next-todo-text="nextTodoText"></next-todo>
      <todo-count :count="count"></todo-count>
    </div>
  </div>
</template>
...
export default Vue.extend({
  components: {TodoCount, NextTodo, TodoEmpty, TodoList},
  computed: {
    todoList(): Todo[] {
